...
variable "subnet_ocid" {
  description = "OCID of the public subnet for the Glen host."
  type        = string
}
...
variable "instance_name" {
  description = "Display name of the Glen authentication host."
  type        = string
  default     = "glen-auth-e2-micro"
}
...
variable "https_ingress_cidr" {
  description = "CIDR allowed to connect to the future Glen HTTPS endpoint."
  type        = string
  default     = "0.0.0.0/0"
}
